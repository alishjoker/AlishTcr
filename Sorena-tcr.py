...
[Respo︎n]
[Bot cancel]
Creator Bot : Alish Joker line.me/ti/p/~joker.alish
"""
KAC=[cl,ki,kk,kc]
...
wait = {
    ...
    'timeline':True,
    'autoAdd':True,
    'message':"Owenr line.me/ti/p/~joker.alish",
    "lang":"JP",
    "comment":"Owenr line.me/ti/p/~joker.alish",
    "commentOn":False,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
            ...
            if msg.contentType == 13:
               if wait["wblack"] == True:
                ...
                if msg.toType == 2:
                    ...
                    ki.updateGroup(X)
                    if wait["lang"] == "JP":
                        ki.sendText(msg.to,"Done ﷽༒༺ҘՓԽՅԿԸ༻༒﷽1")
                    else:
                ...
                if msg.toType == 2:
                    ...
                    kk.updateGroup(X)
                    if wait["lang"] == "JP":
                        kk.sendText(msg.to,"Done ﷽༒༺ҘՓԽՅԿԸ༻༒﷽")
                    else:
                ...
                if msg.toType == 2:
                    ...
                    kc.updateGroup(X)
                    if wait["lang"] == "JP":
                        kc.sendText(msg.to,"Done ﷽༒༺ҘՓԽՅԿԸ༻༒﷽")
                    else:
                ...
                if msg.toType == 2:
                    ...
                    ki.updateGroup(X)
                    if wait["lang"] == "JP":
                        ki.sendText(msg.to,"Done ﷽༒༺ҘՓԽՅԿԸ༻༒﷽")
                    else:
...
#-----------------------------------------------
                ...
                ki.sendText(msg.to,"Selamat datang di ﷽༒༺ҘՓԽՅԿԸ༻༒﷽ Family Room")
...
#-----------------------------------------------
                ...
                start = time.time()
                cl.sendText(msg.to, "Creator Bot : Alish Joker...")
